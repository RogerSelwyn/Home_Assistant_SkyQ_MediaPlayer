...
from custom_components.skyq.skyq.ws4py import WS_KEY, WS_VERSION
from custom_components.skyq.skyq.ws4py.exc import HandshakeError, StreamClosed
from custom_components.skyq.skyq.ws4py.streaming import Stream
from custom_components.skyq.skyq.ws4py.messaging import Message, PingControlMessage,\
    PongControlMessage
from custom_components.skyq.skyq.ws4py.compat import basestring, unicode
