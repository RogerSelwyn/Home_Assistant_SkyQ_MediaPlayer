...
from custom_components.skyq.skyq.ws4py.exc import FrameTooLargeException, ProtocolException
from custom_components.skyq.skyq.ws4py.compat import py3k, ord, range
